      ...
      <div className="cardWrapper">
        ...
        <div className="buttonWrapper"></div>
          <div id="thumbContainer">
            <ThumbUpIcon style={{fontSize:"4em", color: "white"}}/>
            <ThumbDownIcon style={{fontSize:"4em", color: "white"}}/>
          </div> 
          {this.props.usersRedux.authenticated ? 
            <>
            {this.props.showRemove ?
              <Button variant="contained" className="movie-card-button" onClick={() => this.removeFromWatchlist(this.props.movie)}>Remove from Watchlist</Button>
              : 
              <Button variant="contained" className="movie-card-button" onClick={() => this.addToWatchlist(this.props.movie)}>Add To Watchlist</Button>}
            </> : null
          }
        </div>
